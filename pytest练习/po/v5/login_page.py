...
class LoginPage(object):
    ...
    def __init__(self):
        ...
        self.findlogin = (By.XPATH, '//*[@id="s-top-loginbtn"]')  # 首页登录按钮
        self.name = (By.XPATH, '//*[@id="TANGRAM__PSP_11__userName"]')  # 用户名
        self.pwd = (By.XPATH, '//*[@id="TANGRAM__PSP_11__password"]')  # 密码
        self.btn = (By.XPATH, '//*[@id="TANGRAM__PSP_11__password"]')  # 登录按钮

    def find_login(self):
        """定位首页登录按钮方法"""
        return self.driver.find_element(self.findlogin[0], self.findlogin[1])
